...
class UserAdmin(BaseUserAdmin):
    ...
    """This displays the list of users and the filter"""
    list_display = ('email', 'get_full_name', 'roles')
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'first_name','middle_name', 'last_name','roles', 'is_superuser', 'is_active', 'password1', 'password2'),
        }),
    )
    search_fields = ('email',)
    ordering = ('email',)
